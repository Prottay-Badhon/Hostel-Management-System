...
<table>
<tr><td style="padding:5px">Email</td></tr>
<tr><td><input type="email" placeholder="Enter email" name="mail" style="padding:5px;width:155%;height:50px"/></td></tr>
...
<tr><td style=""><input id="logButton"type="submit" value="Login" style="padding:5px;width:155%;background:#6666e2;height:50px;border-radius:8px;border:white;"/></td></tr>
</table>
</form>
<?php
